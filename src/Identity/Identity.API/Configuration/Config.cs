...
{
    // define the initial data for identity
    public static class Config
    {
        // define Identity Resource
        ...
        public static IEnumerable<Client> GetClients(Dictionary<string, string> clientUrls)
        {
            return new List<Client>()
            {
                ...
                new Client
                {
                    ...
                    RequireConsent = false, // không yêu cầu scope, nếu bằng true thì người dùng được chọn những gì chia sẻ
                    AllowOfflineAccess = true,
                    AlwaysIncludeUserClaimsInIdToken = true,
                    RedirectUris = new List<string>
                        {
                            $"{clientUrls["ExamWebApp"]}/authentication/login-callback"
                        }, // sau khi login thì identity call back về application
                    PostLogoutRedirectUris = new List<string>
                        {
                            $"{clientUrls["ExamWebApp"]}/authentication/logout-callback"
                        }, // sau khi log thì identity call back về application
